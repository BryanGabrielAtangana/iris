...
- All adapters now prepend a directive instructing the agent to call `iris_find` before improvising (not just the Tier-1 inventory), making skill discovery plug-and-play instead of opt-in.
